        ...
        if (existing == null) {
            Ingress ingress = new IngressBuilder()
                    .withNewMetadata()
                        ...
                        .addToAnnotations("nginx.ingress.kubernetes.io/proxy-buffering", "off")
                        .addToAnnotations("nginx.ingress.kubernetes.io/proxy-http-version", "1.1")
                        .addToAnnotations("nginx.ingress.kubernetes.io/limit-connections", "200")
                        .addToAnnotations("nginx.ingress.kubernetes.io/proxy-next-upstream", "error timeout invalid_header http_502 http_503")
                        .addToAnnotations("nginx.ingress.kubernetes.io/proxy-next-upstream-tries", "3")
                        .addNewOwnerReference()
                            .withApiVersion(ws.getApiVersion())
                            .withKind(ws.getKind())
                            .withName(ws.getMetadata().getName())
